...
| [第 11 章 Fusion：融合算子](https://github.com/datawhalechina/hello-gpu/blob/main/docs/part2-kernels/chapter11/index.md) | 用 FlashAttention-style 在线 Attention 学习减少中间写回与 IO-aware | ✅ |
