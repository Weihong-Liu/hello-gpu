---
title: "第18章 小模型 LLM 解码 + Agent 自动优化"
description: "Hello GPU 第18章 · Qwen 0.5B/1.8B 量化、decode 算子视角、Agent 优化 KV cache/精度"
---

# 第18章 小模型 LLM 解码 + Agent 自动优化
